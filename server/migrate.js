...
async function main() {
  await pool.query(`
    ...
    CREATE TABLE IF NOT EXISTS delivery_distance_rates (
      id UUID PRIMARY KEY DEFAULT gen_random_uuid(), min_meters INTEGER NOT NULL CHECK (min_meters >= 0),
      max_meters INTEGER, price NUMERIC(10,2) NOT NULL CHECK (price >= 0), is_active BOOLEAN NOT NULL DEFAULT true,
      created_at TIMESTAMPTZ NOT NULL DEFAULT now()
    );

    CREATE TABLE IF NOT EXISTS user_locations (
      user_id UUID PRIMARY KEY REFERENCES users(id) ON DELETE CASCADE, latitude DOUBLE PRECISION NOT NULL,
    ...
    CREATE TABLE IF NOT EXISTS location_history (
      ...
      heading DOUBLE PRECISION, speed DOUBLE PRECISION, created_at TIMESTAMPTZ NOT NULL DEFAULT now()
    );
    ...
    CREATE TABLE IF NOT EXISTS orders (
      ...
      driver_id UUID REFERENCES users(id), restaurant_id UUID REFERENCES users(id),
      ...
      delivery_distance_meters INTEGER, delivery_fee NUMERIC(10,2) NOT NULL DEFAULT 0, total_amount NUMERIC(12,2) NOT NULL DEFAULT 0,
